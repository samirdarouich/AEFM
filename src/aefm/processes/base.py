...
__all__ = ["FlowProcess", "DiffusionProcess"]


class FlowProcess(ABC):
    """
    Abstract base class to define Flow processes.
    """
    ...
    def __init__(
        ...
        """
        Args:
            name: name of the Flow process. Default is None.
    ...
    def flow(
        ...
        **kwargs,
        ...
        """
        Flow sample from x_0 to x_1 at time t.
        ...
        Args:
            ...
            output_key: key for the conditional vector field at time t.
...
class DiffusionProcess(ABC):
    ...
    def diffuse(
        ...
        **kwargs,
        ...
        Args:
            ...
            output_key: key to store the corresponding noise.
            kwargs: additional keyword arguments.
        """
        raise NotImplementedError
    ...
    def forward_step(
        ...
        **kwargs,
        ...
        """
        Performs one forward diffusion step to sample x_t+1 ~ p(x_t+1|x_t).
